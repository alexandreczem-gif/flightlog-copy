    ...
    useEffect(() => {
        const loadUser = async () => {
            try {
                ...
                // Verificar se é primeiro login (não tem flight_log_role definida)
                if (!currentUser.flight_log_role || currentUser.flight_log_role === 'Indefinido') {
                        ...
                        <Card className="shadow-xl bg-white border-slate-200 mb-6">
                            ...
                            <CardContent className="p-8">
                                <h2 className="text-xl font-semibold text-slate-800 mb-4 text-center">
                                    Você é Parte da Tripulação/Apoio Solo ou é apenas visitante?
                                </h2>
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    <Button
                                        onClick={handleChooseCrew}
                                        className="h-32 flex flex-col items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white"
                                        disabled={isSaving}
                                    >
                                        <Users className="w-12 h-12" />
                                        <span className="text-lg font-semibold">Sou Tripulante / Apoio Solo</span>
                                    </Button>
                                    
                                    <Button
                                        onClick={handleChooseVisitor}
                                        variant="outline"
                                        className="h-32 flex flex-col items-center justify-center gap-3 border-2"
                                        disabled={isSaving}
                                    >
                                        <Eye className="w-12 h-12" />
                                        <span className="text-lg font-semibold">Sou Visitante</span>
                                    </Button>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="p-6">
                                <div className="space-y-6">
                                    <p className="text-slate-700">
                                        Por favor, preencha seus dados de tripulante:
                                    </p>
                            ...
                            <CardContent className="p-8 text-center">
                                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6 mb-6">
                                    ...
                                    <p className="text-blue-700">
                                        Contate um administrador para finalizar o cadastro do tripulante.
                                    </p>
                                </div>
                                <Button
